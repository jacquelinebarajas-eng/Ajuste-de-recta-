# CÓDIGO PARA EJECUTAR EL MODELO 2
...
ampl.read("modelo2.mod")  #Leer el modelo 2 desde .mod
...
# Cotas superiores e inferiores de e 
y_sup  = y_line + e
y_inf  = y_line - e
...
ax.set_title('Ajuste de recta por modelo 2')
ax.legend(loc='upper left')
ax.grid(True, alpha=0.3)

plt.tight_layout()

plt.savefig('grafica_mod2.png', dpi=300, bbox_inches='tight')
print("Imagen guardada exitosamente como 'grafica_mod2.png'")